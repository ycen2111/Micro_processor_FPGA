...
// 
// Create Date: 04.03.2023 18:31:04
// Design Name: DR ALISTER HAMILTON & Yang Cen
// Module Name: Timer
// Project Name: MicroProcessor
// Target Devices: BAYSY 3 XC7A35T-l CPG236C
// Tool Versions: Vivado 2015.2
// Description: Timerblock. it will output an interrupt whenever reaches target gap times
// 
// Dependencies: 
// 
// Revision:
...
module Timer(
    ...
    parameter InitialIterruptRate = 100; // Default interrupt rate leading to 1 interrupt every 1000 ms
