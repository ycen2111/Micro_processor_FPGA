...
/*        ....................
        FILL IN THIS AREA
        ...................*/
    assign MouseDy = (MouseStatusRaw[7]) ? (MouseStatusRaw[5] ? {MouseStatusRaw[5],8'h00} :{MouseStatusRaw[5],8'hFF} ) : {MouseStatusRaw[5],MouseDyRaw[7:0]}; //check it later
        
    // calculate new mouse position
    assign MouseNewX = {1'b0,MouseX} + {MouseDx>>>distance_times};
    assign MouseNewY = {1'b0,MouseY} - {MouseDy>>>distance_times};
